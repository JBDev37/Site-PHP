...
return array(
	 ...
	 */
	/*database_dsn' => 'mysql:dbname=kurbys',*/
	'database_dsn' => 'mysql:dbname=teenadviissecret;host=localhost',
    /*'database_dsn' => 'mysql:dbname=teenadviissecret;host=teenadviissecret.mysql.db',*/
	/**
	 * (string) The username for the DSN string.
	 */
	/*'database_user' => 'teenadviissecret',*/
	'database_user' => 'root',

	/**
	 * (string) The password for the DSN string.
	 */
	/*'database_pass' => 'TeenAdvices7',*/
	'database_pass' => 'root',
	/*'database_pass' => '*Kurbys7*',*/
