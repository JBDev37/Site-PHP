...
<div class="container-messages">
    ...
    <form id="contact" method="post" action="message_envoye_bug.php">

    <fieldset><legend style="color: #0a68b4"><b>Signaler un bug</b></legend>
         <div class="presentation-site">Tu as repéré un bug ? N'hésite pas à le signaler. </br></br></div>
