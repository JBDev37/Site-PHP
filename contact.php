...
<div class="container-messages">
    ...
    <form id="contact" method="post" action="message_envoye_contact.php">

    <fieldset><legend style="color: #0a68b4"><b>Contact</b></legend>
         <div class="presentation-site">Une question sur le site ? N'hésitez pas à utiliser ce formulaire </br></br></div>
       
    </fieldset>
 
    <fieldset>
        <strong>Email</strong><br/>
        <p><input type="email" id="objet" name="mail" required class="form-control input-blanc"  value="" tabindex="3" /></p>
