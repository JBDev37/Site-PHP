...
<legend class="legend_classement">Mes amis</legend>
...
<div class="message-gauche">
    ...
    <div class="container-messages-gauche">
	      ...
	      <div class="footer-message">
				...
				<form method="POST">
                    <input type="submit" value="Supprimer" name="supprimer" class="btn btn-xs btn-danger demande_amis" >
                 </form>
